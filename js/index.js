...
//estava tentando fazer com o JavaScript, mas estava muito completo, eu estava
//seguindo por esse caminho

const menulinks = document.querySelectorAll('#sidebar-menu a[href^="#"]')
    menulinks.forEach((links) => {
    links.addEventListener("click", scrollLink)
    
  })


/*script desafio Ivens fim */